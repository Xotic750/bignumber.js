...
/*jslint ass: true, bitwise: true, plusplus: true, sub: true, white: true, maxerr: 500 */
...
;(function ( global ) {
    ...
    */
    ...
    BigNumber['config'] = function () {
        var v, p,
            ...
            has = o && typeof o === 'object'
              ? function () {if ( o.hasOwnProperty(p) ) return ( v = o[p] ) !== null && typeof v !== 'undefined'}
              : function () {if ( a.length > i ) return ( v = a[i++] ) !== null && typeof v !== 'undefined'};
            ...
            for ( bIn = bIn || baseIn; i < strL; i++ ) {
                ...
                for ( arr[0] += DIGITS.indexOf( str.charAt(i) ), j = 0;
                    ...
                    if ( arr[j] > baseOut - 1 ) {
                        ...
                        if ( arr[j + 1] === null || typeof arr[j + 1] === 'undefined' ) {
                            arr[j + 1] = 0;
                        }
    ...
    function divide( dvd, dvs, exp, s, base, isOdd ) {
        ...
        } while ( ( dvdI++ < dvdL || (rem[0] !== null && typeof rem[0] !== 'undefined' ) ) && s-- );
        ...
        // Round?
        if ( qi > dig ) {
            rnd( quo, DECIMAL_PLACES, base, isOdd, rem[0] !== null && typeof rem[0] !== 'undefined' );
        }
    ...
    function rnd( x, dp, base, isOdd, r ) {
        var xc = x['c'],
             ...
             */
            more = r || i < 0 || (xc[i + 1] !== null && typeof xc[i + 1] !== 'undefined');

        r = ROUNDING_MODE < 4
          ? ( ( next !== null && typeof next !== 'undefined') || more ) &&
            ( ROUNDING_MODE === 0 ||
    ...
    P['round'] = function ( dp, rm ) {
        ...
        dp = dp === null || typeof dp === 'undefined' || ( ( ( outOfRange = dp < 0 || dp > MAX ) ||
          parse(dp) !== (+dp) ) &&
        ...
        rm = rm === null || typeof rm === 'undefined' || ( ( ( outOfRange = rm < 0 || rm > 8 ) ||
    ...
    P['toExponential'] = P['toE'] = function ( dp ) {
        ...
        return format( this,
          ( dp === null || typeof dp === 'undefined' || ( ( outOfRange = dp < 0 || dp > MAX ) ||
    ...
    P['toFixed'] = P['toF'] = function ( dp ) {
        ...
        if ( !( dp === null || typeof dp === 'undefined' || ( ( outOfRange = dp < 0 || dp > MAX ) ||
            parse(dp) !== (+dp) && dp !== 0 ) &&
    ...
    P['toFraction'] = P['toFr'] = function ( maxD ) {
        ...
        if ( maxD === null || typeof maxD === 'undefined' ||
    ...
    P['toPrecision'] = P['toP'] = function ( sd ) {
         ...
         */
        return sd === null || typeof sd === 'undefined' || ( ( ( outOfRange = sd < 1 || sd > MAX ) ||
          parse(sd) !== (+sd) ) &&
